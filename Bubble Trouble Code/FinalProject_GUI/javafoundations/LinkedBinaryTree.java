...
public class LinkedBinaryTree<T> implements BinaryTree<T>
{
  ...
  public LinkedBinaryTree<T> getRight() {
    ...
    if (root == null) {
      throw new EmptyCollectionException ("LinkedBinaryTree<T> has no root. " +
                                          "Cannot find right of null root.");
    }
  ...
  public static void main (String [] args) {
     ...
     LinkedBinaryTree<String> beatles = new LinkedBinaryTree<String>("takis",t2,t3);
